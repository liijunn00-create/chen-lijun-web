      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-7rem)] max-w-[1700px] flex-col justify-end pb-14">
        <div className="glass-panel-strong mb-16 grid gap-8 p-7 sm:p-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end lg:p-14">
            ...
            >
              {heroContent.ctas.map((cta) => (
                <a
                  key={cta.href}
                  href={cta.href}
                  className="glass-chip px-4 py-3 text-xs font-semibold uppercase tracking-[0.16em] text-[#171513] transition hover:bg-[#171513] hover:text-[#f8f5ef]"
                >
                  {cta.label}
                </a>
              ))}
          ...
          >
            ...
            <p className="mt-6 text-base leading-7 text-[#5c5751]">{heroContent.note}</p>
